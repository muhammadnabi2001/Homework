    ...
    <header>
      <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
        ...
        <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
          ...
          <a class="me-3 py-2 link-body-emphasis text-decoration-none" href="register.php">Register</a>
          <a class="me-3 py-2 link-body-emphasis text-decoration-none" href="logout.php">Logout</a>
          <a class="py-2 link-body-emphasis text-decoration-none" href="#">user</a>
            ...
            foreach ($data as $d) { ?>
              <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                  ...
                  <a href="<?=isset($_SESSION['name']) ? 'like.php?id='.$d['id'] :'login.php?id='.$d['id']?>" class="btn btn-outline-primary"><i class="bi bi-hand-thumbs-up"></i></a>
                  <a href="<?=isset($_SESSION['name']) ? 'like.php?id='.$d['id'] :'login.php?id='.$d['id']?>"  class="btn btn-outline-primary"><i class="bi bi-hand-thumbs-down"></i></a>
